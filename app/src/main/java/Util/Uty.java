...
//            System.out.println("Done");
    ...
    public static void WriteMapToFile(HashMap<String, Object> hmap, File outputFile) throws IOException {
    ...
    public static HashMap<String, Object> fileToMap(String file) {
...
//                    newMap =(HashMap<String, ArrayList<byte[]>>)ois.readObject();
        } catch (IOException e) {
            e.printStackTrace();
...
//    }
    ...
    public static byte[] mapTOByte(HashMap hmap) {
...
//        HashMap<String, ArrayList<byte[]>> newMap=null;
        HashMap<String, byte[]> newMap=null;

        try {
//            newMap=(HashMap<String,ArrayList<byte[]>>) in.readObject();
            newMap=(HashMap<String, byte[]>) in.readObject();
...
//        char[] key = {'K', 'C', 'Q'}; //Can be any chars, and any length array
        char[] key = pass.toCharArray(); //Can be any chars, and any length array
