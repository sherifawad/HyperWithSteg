...
public class Client implements Serializable {
    ...
    private  static ECPoint pointOfClientPartialKey;
    private  static ECPoint pointOfBankPartialKey;
    ...
    public static ECPoint getPointOfClientPartialKey() {
    ...
    public static ECPoint getPointOfBankPartialKey() {
